                     ...
                     <legend></legend>
                        <form action="/member/findId.do" method="post">
                           <div class="login_idPw">
                              E-MAIL : <input type="email" name="user_email"  placeholder=" 이메일을 입력해주세요." class="login_Blank" required><br>
                              PHONE : <input type="tel" name="user_phone" placeholder=" 번호를 입력해주세요." class="login_Blank" required><br>
                           </div>
                           <div class="login_btn">
