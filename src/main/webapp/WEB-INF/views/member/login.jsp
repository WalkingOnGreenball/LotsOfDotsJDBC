                     ...
                     <legend></legend>
                        <form action="/member/login.do" method="post">
                           <div class="login_idPw">
                              ID : <input type="text" name="user_id" placeholder=" 아이디를 입력해주세요." class="login_Blank" required><br>
                              PW : <input type="password" name="user_pw" placeholder=" 비밀번호를 입력해주세요." class="login_Blank" required><br>
                           </div>
                           <div class="login_btn">
